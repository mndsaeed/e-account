<template>
  <div class="bg-gradient-to-r from-blue-500 via-blue-400 to-blue-300">
    <div class="flex justify-center">
      <img
        class="absolute object-cover mt-6"
        src="../assets/imgs/SFB-logo.png"
        alt=""
      />
    </div>
    ...
    <div class="flex items-center justify-center h-screen">
      <div
        class="w-full max-w-lg p-4 bg-white border border-gray-200 rounded-sm shadow-md sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700"
      >
