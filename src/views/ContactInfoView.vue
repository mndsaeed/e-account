      ...
      <div class="flex flex-col mb-5 space-y-2 text-left">
        <div class="grid md:grid-cols-2 md:gap-20">
          <div class="relative z-10 w-full mb-6 group">
            ...
            <span class="mt-2 text-xs font-semibold text-red-600 dark:text-red-400" v-for="error of v$.state.$errors"
              :key="error.$uid">
              {{ error.$message }}
            </span>
          </div>
          <div class="relative w-full mb-6 group">
            ...
            <span class="mt-2 text-xs font-semibold text-red-600 dark:text-red-400" v-for="error of v$.city.$errors"
              :key="error.$uid">
              {{ error.$message }}
            </span>
          </div>
        ...
        <div class="grid md:grid-cols-2 md:gap-20">
          <div class="relative z-0 flex flex-row w-full group max-sm:mb-6">
            <div class="relative z-0 w-full">
              ...
              <span class="mt-2 text-xs font-semibold text-red-600 dark:text-red-400" v-for="error of v$.area.$errors"
                :key="error.$uid">
                {{ error.$message }}
              </span>
            </div>
          ...
          <div class="relative z-0 flex flex-row w-full group">
            <div class="relative z-0 w-full mb-6">
              <input v-model="formData.street" placeholder="Street" type="text" id="base-input"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
              <span class="mt-2 text-xs font-semibold text-red-600 dark:text-red-400" v-for="error of v$.street.$errors"
                :key="error.$uid">
                {{ error.$message }}
              </span>
            </div>
          ...
          <div class="relative z-0 flex flex-row w-full group">
            <div class="relative z-0 w-full mb-6">
              <input v-model="formData.poBox" placeholder="P.O BOX" type="text" id="base-input"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
              <span class="mt-2 text-xs font-semibold text-red-600 dark:text-red-400" v-for="error of v$.poBox.$errors"
                :key="error.$uid">
                {{ error.$message }}
              </span>
            </div>
          ...
          <div class="relative z-0 flex flex-row w-full group">
            <div class="relative z-0 w-full mb-6">
              <input v-model="formData.email" placeholder="E-mail Address" type="email" id="base-input"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
              <span class="mt-2 text-xs font-semibold text-red-600 dark:text-red-400" v-for="error of v$.email.$errors"
                :key="error.$uid">
                {{ error.$message }}
              </span>
            </div>
      ...
      <div class="flex flex-row justify-between gap-5 max-sm:justify-center max-sm:items-center max-sm:py-5">
        ...
        <div class="flex gap-5 max-sm:justify-center max-sm:items-center max-sm:py-5">
          ...
          <div class="flex justify-end items-end mt-[4.5rem] max-sm:mt-0">
            ...
            <BaseButton @click="validate" :icon="mdiArrowRight" responsive buttonName="Next" class="w-32" />
            <!-- </router-link> -->
          </div>
        </div>
      </div>
