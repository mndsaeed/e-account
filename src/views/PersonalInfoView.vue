      ...
      <div class="flex flex-col text-left space-y-2 mb-5">
        <form action="submit" @submit="checkForm">
          ...
          <div class="grid md:grid-cols-2 md:gap-20 max-sm:mb-5">
            <div class="relative z-0 mb-6 w-full group">
              <input required v-model="formData.dob" placeholder="Date of Birth" type="text"
                onfocus="(this.type='date')" onblur="(this.type='text')" id="base-input"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
              <span class="mt-2 font-semibold text-xs text-red-600 dark:text-red-400" v-for="error of v$.dob.$errors"
                :key="error.$uid">
                {{ error.$message }}
              </span>
            </div>
            <div class="flex flex-col">
              <div class="flex flex-row relative z-0 w-full group">
                <div
                  ...
                  <input required v-model="formData.gender" :value="true" id="bordered-radio-1" type="radio"
                    name="bordered-radio"
                  ...
                  <label for="bordered-radio-1"
                    class="w-full py-2.5 ml-2 text-sm font-sm text-gray-500 dark:text-gray-300">Male</label>
                </div>
                <div
                  class="flex items-center w-full pl-4 border bg-gray-50 border-gray-200 rounded-sm dark:border-gray-700">
                  <input required v-model="formData.gender" :value="false" id="bordered-radio-2" type="radio"
                    name="bordered-radio"
                  ...
                  <label for="bordered-radio-2"
                    class="w-full py-2.5 ml-2 text-sm font-sm text-gray-500 dark:text-gray-300">Female</label>
                </div>
              </div>
              <span class="mt-2 font-semibold text-xs text-red-600 dark:text-red-400" v-for="error of v$.gender.$errors"
                :key="error.$uid">
                {{ error.$message }}
              </span>
            </div>
          ...
          <div class="grid md:grid-cols-2 md:gap-20">
            ...
            <div class="flex flex-col max-sm:flex-row max-sm:mb-5">
              <div class="flex flex-row relative z-0 w-full group">
                <div
                  class="flex items-center w-full mr-5 pl-4 border bg-gray-50 border-gray-200 rounded-sm dark:border-gray-700">
                  <input required v-model="formData.resident" :value="true" id="r-1" type="radio" name="bordered-radio1"
                    class="w-fit h-2.5 text-blue-600 bg-gray-50 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-1 dark:bg-gray-700 dark:border-gray-600" />
                  <label for="r-1"
                    class="w-full py-2.5 ml-2 text-sm font-sm text-gray-500 dark:text-gray-300">Resident</label>
                </div>
                <div
                  class="flex items-center w-full pl-4 border bg-gray-50 border-gray-200 rounded-sm dark:border-gray-700">
                  <input required v-model="formData.resident" :value="false" id="r-2" type="radio"
                    name="bordered-radio1"
                    class="w-fit h-2.5 text-blue-600 bg-gray-50 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-1 dark:bg-gray-700 dark:border-gray-600" />
                  <label for="r-2"
                    class="w-full py-2.5 ml-2 text-sm font-sm text-gray-500 dark:text-gray-300">Non-Resident</label>
                </div>
              </div>
              <span class="font-semibold text-xs text-red-600 dark:text-red-400" v-for="error of v$.resident.$errors"
                :key="error.$uid">
                {{ error.$message }}
              </span>
            </div>
          ...
          <div class="grid md:grid-cols-2 md:gap-20">
            <div class="relative z-0 mb-6 w-full group">
              ...
              <span class="mt-2 font-semibold text-xs text-red-600 dark:text-red-400" v-for="error of v$.Id.$errors"
                :key="error.$uid">
                {{ error.$message }}
              </span>
            </div>
    ...
    <div class="flex flex-row justify-end gap-5">
      <div class="flex justify-end items-end">
        <router-link to="/signin">
          <BaseButton @click="checkForm" buttonName="Save and Quit" class="w-32 bg-red-600 hover:bg-red-700" />
        </router-link>
      </div>
