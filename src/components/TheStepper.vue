    ...
    >
      ...
      >
        ...
        >
          ...
          <span
            v-else
            class="mr-2 border rounded-full p-px"
      ...
      >
        ...
        >
          ...
          <span
            v-else
            class="mr-2 border rounded-full p-px"
            :class="step >= 4 ? ' bg-primary text-white' : ''"
          >
      ...
      >
        ...
        >
          ...
          <span
            v-else
            class="mr-2 border rounded-full p-px"
            :class="step >= 5 ? ' bg-primary text-white' : ''"
          >
      ...
      <li class="flex items-center" :class="step >= 6 ? 'text-primary' : ''">
        ...
        <span
          v-else
          class="mr-2 border-2 rounded-full p-px"
          :class="step >= 6 ? ' bg-primary text-white' : ''"
        >
