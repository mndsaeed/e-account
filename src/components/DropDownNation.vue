<template>
  <Listbox as="div" v-model="selected">
    <div class="relative mt-1">
      ...
      >
        <ListboxOptions
          class="absolute z-10 mt-1 max-h-36 w-full overflow-auto rounded-sm bg-white py-1 text-base text-center shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm"
        >
          <ListboxOption
            as="template"
